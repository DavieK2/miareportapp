        ...
        <div class="card-body">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 form-control-label" for="mia_centre_name">MIA Centre Name</label>

                            <div class="col-md-10">
                                <input class="form-control" type="text" name="mia_centre_name" id="mia_centre_name" 
                                placeholder="MIA Centre Name" maxlength="255" value="{{ old('mia_centre_name') }}" required="">
                            </div><!--col-->
                        </div>
